...
export let payloadReq = `
  <serviceRequest serviceName="VendasGOLSP.getVendasFaturamento">
    <requestBody>
      <vendas PERIODO.INI="${getFirstDayOfPreviousMonth()} 00:00:00" PERIODO.FIN="${getTodayStart().toLocaleDateString()} 23:59:59" TIPO="VENDEDOR" _id="-50" CONFIG_CONSOLIDACAO="-1" EMPRESA="999,4,2,3,1,100" GERENTESUBORDINADO="false" TIPO_AGRUPAMENTO="G"/>
      <clientEventList/>
    </requestBody>
  </serviceRequest>
`;
