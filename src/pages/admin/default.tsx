            ...
            content: (
                <div>
                    <Grid
                        ...
                        <DailyTraffic/>
                        <Bloco1 udiSFormat={udiSFormat} diasFaltantes={diasFaltantes} isLoadingData={isLoadingData} metaUdi={metaUdi} metaDiariaCalcUDI={metaDiariaCalcUDI} diasUteisNoMes={diasUteisNoMes} diasConcluidos={diasConcluidos} tendenciaUDI={tendenciaUDI} />
                        <Bloco2 gynSFormat={gynSFormat} diasFaltantes={diasFaltantes} isLoadingData={isLoadingData} metaGyn={metaGyn} metaDiariaCalcGYN={metaDiariaCalcGYN} diasUteisNoMes={diasUteisNoMes} diasConcluidos={diasConcluidos} tendenciaGYN={tendenciaGYN}/>
                    </Grid>
                    <Box mt='15'>
                        <Bloco3/>
                    </Box>
